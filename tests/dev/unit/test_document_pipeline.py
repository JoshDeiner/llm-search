...
@pytest.fixture
def document_pipeline(fake_document_service: FakeDocumentService) -> DocumentPipeline:
...
@pytest.mark.unit
def test_save_to_file(document_pipeline: DocumentPipeline, fake_document_service: FakeDocumentService) -> None:
    # Act
...
@pytest.mark.unit
def test_save_to_file_permission_error(document_pipeline: DocumentPipeline, fake_document_service: FakeDocumentService) -> None:
    # Arrange
...
@pytest.mark.unit
def test_save_to_file_io_error(document_pipeline: DocumentPipeline, fake_document_service: FakeDocumentService) -> None:
    # Arrange
...
@pytest.mark.unit
def test_save_to_file_unsupported_extension(document_pipeline: DocumentPipeline) -> None:
    # Act & Assert
