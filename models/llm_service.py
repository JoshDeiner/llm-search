...
if __name__ == "__main__":
    ...
    model_choice = os.getenv("LLM_MODEL", "gemini")  # Default to Gemini if no environment variable set
    llm = get_llm_service(model_choice)
    
    # Generate response
    response = llm.generate_response("Explain how AI works" if model_choice == "gemini" else "Why is the sky blue?")
