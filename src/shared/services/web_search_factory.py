...
from src.features.users.user_validation_service import QueryValidationService
from src.shared.services.web_search_pipeline import WebSearchPipeline
...
def create_web_search_pipeline() -> WebSearchPipeline:
    ...
    return WebSearchPipeline(search_engine_service, user_service, query_validation_service)