...
class DocumentService:
    def __init__(self):
        self.documents = {}  # In-memory storage for demo purposes (consider using a database)
...
if __name__ == '__main__':
    ...
    document_service.create_document(user_service, 'user1', 'news_report.md', 'Breaking News', 'This is a sample news report.')
